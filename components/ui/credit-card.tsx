                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <Input
                            ...
                            className={cn('transition-all duration-200', focusedField === 'cardholderName' && 'ring-2 ring-blue-500')}
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onBlur={() => setFocusedField(null)}
                            className={cn('font-mono transition-all duration-200', focusedField === 'cardNumber' && 'ring-2 ring-blue-500')}
                            maxLength={19}
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <Select value={currentValue.expiryMonth} onValueChange={(value) => handleInputChange('expiryMonth', value)}>
                                <SelectTrigger
                                    className={cn('transition-all duration-200', focusedField === 'expiryMonth' && 'ring-2 ring-blue-500')}
                                >
                        ...
                        <div>
                            ...
                            <Select value={currentValue.expiryYear} onValueChange={(value) => handleInputChange('expiryYear', value)}>
                                <SelectTrigger
                                    className={cn('transition-all duration-200', focusedField === 'expiryYear' && 'ring-2 ring-blue-500')}
                                >
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                className={cn('font-mono text-center transition-all duration-200', focusedField === 'cvv' && 'ring-2 ring-blue-500')}
