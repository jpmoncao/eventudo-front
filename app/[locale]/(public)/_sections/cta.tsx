...
export default function CtaSection() {
    ...
    return (
        <section id="join" className="bg-primary/30 dark:bg-primary/10 shadow-[0_0_40px_10px] shadow-primary/40 dark:shadow-primary/5 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 border border-primary-foreground/60 dark:border-primary/90 rounded-2xl px-4 py-8 md:py-32 max-w-[800px] mx-auto mb-12">
